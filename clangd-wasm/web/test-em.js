...
function __asyncjs___await_response() { return Asyncify.handleAsync(async () => { self.postMessage({ cmd: 'callHandler', handler: 'cx-get-message', args: [Module['_pthread_self']()] }); _onmessage = self.onmessage; const input = await new Promise(res => { self.onmessage = e => { if (e.data.cmd === 'cx-message') { self.onmessage = _onmessage; res(e.data.message); } else { _onmessage(e); } } }); return stringToNewUTF8(input); }); }
...
// end include: preamble.js
  ...
  allocateUnusedWorker:function() {
        ...
        var pthreadMainJs = locateFile('test-em.worker.js');
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(6, 1, fd,offset_low, offset_high,whence,newOffset);
...
var proxiedFunctionTable = [null,_proc_exit,exitOnMainThread,pthreadCreateProxied,_fd_close,_fd_read,_fd_seek,_fd_write];
...
var wasmImports = {
  ...
  __asyncjs___await_response: __asyncjs___await_response,
...
var ___start_em_js = Module['___start_em_js'] = 68516;
var ___stop_em_js = Module['___stop_em_js'] = 68918;
